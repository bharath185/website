  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] text-slate-900 pt-20 sm:pt-24 pb-20 font-sans relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-8 sm:space-y-10">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-2.5">
          ...
          >
            ...
            <span className="text-[10px] font-mono font-bold text-[#122f87] uppercase tracking-widest">
              CAREERS AT BHARAT MACHINE TOOLS
            </span>
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-2xl sm:text-4xl font-extrabold tracking-tight text-slate-900 uppercase font-display"
          >
          ...
          <motion.p 
            ...
            className="text-slate-600 text-xs sm:text-sm max-w-md mx-auto font-light leading-relaxed"
          >
            Join our machine tool engineering team in Bangalore. Explore current open roles and apply below.
          </motion.p>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200/80 pb-4">
            <div>
              ...
              <h2 className="text-lg sm:text-xl font-bold text-slate-900 uppercase font-display">
          ...
          {/* Job Listings Grid */}
          {loading ? (
            <div className="bg-white rounded-3xl border border-slate-200 p-10 text-center flex flex-col items-center gap-3">
              <div className="animate-spin rounded-full h-7 w-7 border-t-2 border-b-2 border-[#122f87]" />
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-10 text-center space-y-2">
              ...
              <p className="text-xs text-slate-500">Please select &quot;All&quot; or email your CV directly to HR.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
              {filteredJobs.map((job, idx) => (
                <motion.div 
                  ...
                  className="group bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs hover:shadow-lg hover:border-blue-400/50 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer flex flex-col justify-between space-y-3"
                >
                  <div className="space-y-2">
                    ...
                    <h3 className="text-base font-bold text-slate-900 group-hover:text-[#122f87] transition-colors leading-snug font-display">
                      {job.title}
                    </h3>
        ...
        {/* ========================================================================= */}
        {/* COMPACT GENERAL CV BANNER                                                 */}
        {/* ========================================================================= */}
        <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-br from-[#0b1b4f] via-[#122f87] to-[#1a3fa8] text-white shadow-md flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="space-y-1 text-center sm:text-left">
            ...
            <p className="text-xs text-blue-100/80 font-light">
              Send your CV directly to our HR team for upcoming machine tool roles.
            </p>
          </div>

          <a
            href="mailto:bmt.abbas@gmail.com?subject=Job%20Application%20-%20BMT%20Careers"
            className="px-4 py-2 bg-white text-[#122f87] hover:bg-blue-50 font-bold rounded-xl text-xs font-mono uppercase tracking-wider transition-colors shadow-sm shrink-0 inline-flex items-center gap-1.5 cursor-pointer"
          >
        ...
        {selectedJob && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
            ...
            >
              ...
              {/* Modal Header */}
              <div className="border-b border-slate-100 pb-3 space-y-1.5 pr-8">
