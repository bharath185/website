...
export default function CareersPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] text-slate-900 pt-28 sm:pt-32 pb-20 font-sans relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 max-w-3xl mx-auto space-y-3">
          <span className="text-[10px] font-mono font-bold text-blue-600 uppercase tracking-widest bg-blue-50 px-3 py-1 rounded-md border border-blue-200/40 inline-flex items-center gap-1.5">
            ...
            CAREERS AT BMT BHARAT
          </span>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-slate-900 uppercase font-display">
            Build the Future of Precision
          </h1>
          <p className="text-slate-600 text-xs sm:text-sm max-w-2xl mx-auto font-light leading-relaxed">
