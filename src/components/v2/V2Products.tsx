            ...
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      layoutId="verticalGreenIndicator"
              ...
              <AnimatePresence mode="wait">
                {filtered.map((p) => (
                  <motion.div
                    ...
                    className="group bg-gradient-to-br from-[#f8fafc] to-[#e2e8f0] border border-slate-300/40 rounded-3xl p-6 sm:p-8 relative flex flex-col justify-between overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 min-h-[240px]"
                  >
                    <div>
                      {/* Product Name (title) */}
