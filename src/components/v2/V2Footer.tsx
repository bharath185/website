    ...
    <footer className="bg-[#020617] border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          {/* Quick Nav Column */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-white mb-6 font-mono">
              Corporate Links
            </h4>
          ...
          <div className="flex flex-col gap-4 text-xs font-light text-slate-400">
            <h4 className="text-xs font-bold uppercase tracking-widest text-white mb-2 font-mono">
              Contact Hub
            </h4>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button
            onClick={scrollToTop}
            className="p-3 bg-slate-900 hover:bg-slate-800 border border-white/5 rounded-2xl transition-all text-slate-400 hover:text-white"
            title="Back to Top"
          >
